I need to figure out what to feed myself for supper every night. This will eventually house an app that will help me figure out what to feed myself, and will only pull from recipes I like and like to make. I'm a picky eater, after all, so something like [What the Fuck Should I Make for Dinner](http://www.whatthefuckshouldimakefordinner.com/) is never as useful or time-saving as it should be for me. Instead, it often leaves me with a sense of existential dread and growing hanger. The goal is to create a GDocs spreadsheet of food I actually like and eat and randomly present myself with recipes I'm actually into to start. We'll see where it goes from there.
